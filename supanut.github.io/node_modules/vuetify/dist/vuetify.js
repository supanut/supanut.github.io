...
(function (global, factory) {
    ...
    return {
      ...
      createScope: options => {
        ...
        const newScope = createScope({
          current: vue.computed(() => (options == null ? void 0 : options.locale) ?? currentScope.current.value),
          fallback: vue.computed(() => (options == null ? void 0 : options.locale) ?? currentScope.fallback.value),
          messages: vue.computed(() => (options == null ? void 0 : options.messages) ?? currentScope.messages.value)
        });
  ...
  const useNestedItem = (id, isGroup) => {
    ...
    const computedId = vue.computed(() => id.value ?? getUid().toString());
    const item = { ...parent,
      id: computedId,
  ...
  const VColorPicker = defineComponent({
    ...
    setup(props) {
      ...
      useRender(() => vue.createVNode(VSheet, {
        ...
        "style": {
          '--v-color-picker-color-hsv': HSVAtoCSS({ ...(currentColor.value ?? nullColor),
            a: 1
          })
        },
  ...
  const version$1 = "3.0.0-next-20220916.0";
  ...
  const version = "3.0.0-next-20220916.0";
